...
def set_locale_n_week_day_names(arg_locale, user_locale, day_format, first_day_week, day_abbr_lenght):
    ...
    def get_loc_day(day_num, lenght):
        ...
        # Wrap with Pango markup to set custom color for day names
        # Color: #458588 (blue) - change this hex code to your preferred color
        return f'<span foreground="#cc241d">{day_name}</span>'
