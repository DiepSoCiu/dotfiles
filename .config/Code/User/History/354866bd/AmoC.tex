...
việc sử dụng nhuần nhuyễn các công thức ta cần phải luyện tập thêm khả năng tưởng tượng hình khối trong không gian.
\xd 
\textbf{Hình trụ:}
\[
    \begin{cases}
        V_\textit{hình trụ} = S_\textit{đáy~} . \textit{~cao} = \pi . R^2 . h \\[0.5em]
        S_{xq\textit{hình trụ}} = S_\textit{đáy~} . \textit{~cao} = 2\pi Rh
    \end{cases}
\]
\xd
\textbf{Hình vuông:}
